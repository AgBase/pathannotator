...
if [ -f "$3"/pathway_group_data_fb* ]; then 	rm "$3"/pathway_group_data_fb*; fi
if [ -f "$3"/*pathway_group_data_fb* ]; then 	rm "$3"/*pathway_group_data_fb*; fi
if [ -f "$3"/fbgn_annotation_ID_fb* ]; then 	rm "$3"/fbgn_annotation_ID_fb*; fi
...
if [ -f "$3"/fbgn_fbtr_fbpp_fb* ]; then  rm "$3"/fbgn_fbtr_fbpp_fb*; fi
