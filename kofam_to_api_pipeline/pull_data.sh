...
then
	...
	wget -r -nd -np -A gz --reject-regex "index*" --accept-regex "signaling_pathway_group_data*" -P $3/ 'https://ftp.flybase.net/releases/current/precomputed_files/genes/'
	wget -r -nd -np -A gz --reject-regex "index*" --accept-regex "metabolic_pathway_group_data*" -P $3/ 'https://ftp.flybase.net/releases/current/precomputed_files/genes/'
	...
	wget -r -nd -np -A gz --reject-regex "index*" --accept-regex "fbgn_annotation_ID_fb*" -P $3/ 'https://ftp.flybase.org/releases/current/precomputed_files/genes/'
	...
	wget -r -nd -np -A gz --reject-regex "index*" --accept-regex "dmel-all-translation*" -P $3/ 'https://ftp.flybase.net/genomes/Drosophila_melanogaster/current/fasta/'
        gunzip $3/dmel-all-translation-*

	#PULL FBGN TO FBPP FILES
	wget -r -nd -np -A gz  --reject-regex "index*" --accept-regex "fbgn_fbtr_fbpp_fb*" -P $3/ 'https://ftp.flybase.net/releases/current/precomputed_files/genes/'
