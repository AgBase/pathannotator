...
#	wget -r -nd -A gz --accept-regex "metabolic_pathway_group_data*" -O $3/metabolic_pathway_group_data_latest.tsv.gz 'ftp://ftp.flybase.net/releases/current/precomputed_files/genes/'
	wget -r -nd -A gz --accept-regex "signaling_pathway_group_data*" -P $3/ 'ftp://ftp.flybase.net/releases/current/precomputed_files/genes/'
	wget -r -nd -A gz --accept-regex "metabolic_pathway_group_data*" -P $3/ 'ftp://ftp.flybase.net/releases/current/precomputed_files/genes/'
...
#	wget -r -nd -A gz --accept-regex "dmel-all-translation*" -O $3/dmel-all-translation-latest.fasta.gz 'ftp://ftp.flybase.net/genomes/Drosophila_melanogaster/current/fasta/'
	wget -r -nd -A gz --accept-regex "dmel-all-translation*" -P $3/ 'ftp://ftp.flybase.net/genomes/Drosophila_melanogaster/current/fasta/'
...
#	wget -r -nd -A gz  --accept-regex "fbgn_fbtr_fbpp_fb*" -O $3/fbgn_fbtr_fbpp_fb_latest.tsv.gz 'ftp://ftp.flybase.net/releases/current/precomputed_files/genes/'
	wget -r -nd -A gz  --accept-regex "fbgn_fbtr_fbpp_fb*" -P $3/ 'ftp://ftp.flybase.net/releases/current/precomputed_files/genes/'
