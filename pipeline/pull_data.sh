...
then
	...
	wget https://s3ftp.flybase.org/genomes/Drosophila_melanogaster/current/fasta/dmel-all-translation-r6.63.fasta.gz -P $3/
        gunzip -f $3/dmel-all-translation-r6.63.fasta.gz
