...
then
	...
	#FLYBASE PULLS ARE NOT RELIABLE IN QUICK SUCCESSION. TO SPEED UP RUNS I AM ADDING THESE FILES DIRECTLY TO THE CONTAINER (THEY ARE HARD-CODED ANYWAY...)
	#THEN THEY CAN BE COPIED TO THE OUTPUT DIRECTORY DURING EACH RUN AS PROCESSED BELOW
	#wget https://s3ftp.flybase.org/releases/FB2025_03/precomputed_files/genes/metabolic_pathway_group_data_fb_2025_03.tsv.gz -O $3/metabolic_pathway_group_data_fb_2025_03.tsv.gz
	#wget https://s3ftp.flybase.org/releases/FB2025_03/precomputed_files/genes/signaling_pathway_group_data_fb_2025_03.tsv.gz -O $3/signaling_pathway_group_data_fb_2025_03.tsv.gz
	...
	#wget https://s3ftp.flybase.org/releases/FB2025_03/precomputed_files/genes/fbgn_annotation_ID_fb_2025_03.tsv.gz -O $3/fbgn_annotation_ID_fb_2025_03.tsv.gz
	...
	#wget https://s3ftp.flybase.org/releases/FB2025_03/precomputed_files/genes/fbgn_fbtr_fbpp_fb_2025_03.tsv.gz -O $3/fbgn_fbtr_fbpp_fb_2025_03.tsv.gz
	...
	#wget https://s3ftp.flybase.org/releases/FB2025_03/precomputed_files/collaborators/gp_information.fb.gz -O $3/gp_information.fb.gz
	wget https://reactome.org/download/current/UniProt2Reactome_All_Levels.txt -O $3/UniProt2Reactome_All_Levels.txt
