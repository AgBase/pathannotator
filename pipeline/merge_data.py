...
parser.add_argument('--kofam', choices=['yes', 'no'])
...
flybase = args.flybase # (default is 'NA') FB for Flybase and DME Reactome annotations, NA for none
...
if kofam == "no" and species != "NA":
    if not os.path.exists(f"{indir}/ko_ncbi.tsv"):
